				...
				if (unhandledProperties.has("loader")) {
					...
					if (loader.includes("!")) {
						throw ruleSetCompiler.error(
							`${path}.loader`,
							loader,
							"Exclamation mark separated icons lists has been removed in favor of the 'use' property with arrays"
						);
					}
					...
					if (loader.includes("?")) {
						throw ruleSetCompiler.error(
							`${path}.loader`,
							loader,
							"Query arguments on 'icons' has been removed in favor of the 'options' property"
						);
					}
