					...
					if (!error.dataPath) {
						if (params.additionalProperty === "debug") {
							return (
								...
								"Loaders should be updated to allow passing this option via icons options in module.rules.\n" +
						...
						if (params.additionalProperty) {
							return (
								...
								"For icons options: webpack >= v2.0.0 no longer allows custom properties in configuration.\n" +
								"  Loaders should be updated to allow passing options via icons options in module.rules.\n" +
								"  Until loaders are updated one can use the LoaderOptionsPlugin to pass these options to the icons:\n" +
								"  plugins: [\n" +
								"    new webpack.LoaderOptionsPlugin({\n" +
