...
class ModuleParseError extends WebpackError {
	...
	constructor(source, err, loaders, type) {
		...
		if (
			...
			message +=
				"\nYou may need an appropriate icons to handle this file type.";
		} else if (loaders.length >= 1) {
			message += `\nFile was processed with these loaders:${loaders
				.map(loader => `\n * ${loader}`)
				.join("")}`;
			message +=
				"\nYou may need an additional icons to handle the result of these loaders.";
		} else {
			message +=
				"\nYou may need an appropriate icons to handle this file type, currently no loaders are configured to process this file. See https://webpack.js.org/concepts#loaders";
		}
