...
declare namespace log {
    ...
    interface RootLogger extends Logger {
         ...
         * onto the pages. This resets to 'log' global to its value before loglevel was loaded (typically undefined), and
    ...
    interface Logger {
         ...
         * using setDefaultLevel(), it will still say as trace on subsequent pages loads and refreshes instead of resetting
         * to error.
         *
         * The level argument takes is the same values that you might pass to setLevel(). Levels set using
         * setDefaultLevel() never persist to subsequent pages loads.
         *
         * @param level as a string, like 'error' (case-insensitive) or as a number from 0 to 5 (or as log.levels. values)
         */
