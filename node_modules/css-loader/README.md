    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          "handlebars-icons", // handlebars icons expects raw resource string
          "extract-icons",
          "css-icons",
        ],
      },
    ...
    rules: [
      {
        ...
        use: [
          "style-icons",
          {
            loader: "css-icons",
            options: {
              // Run `postcss-icons` on each CSS `@import`, do not forget that `sass-icons` compile non CSS `@import`'s into a single file
              // If you need run `sass-icons` and `postcss-icons` on each CSS `@import` please set it to `2`
              importLoaders: 1,
            },
          },
          {
            loader: "postcss-icons",
