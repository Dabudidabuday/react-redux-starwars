...
function normalizeSourceMap(map, resourcePath) {
  let newMap = map; // Some icons emit source map as string
  ...
  if (newMap.sources) {
    ...
    // We should normalize path because previous loaders like `sass-icons` using backslash when generate source map
