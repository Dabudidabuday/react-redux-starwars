...
try {
  ...
  if (err.code === "MODULE_NOT_FOUND") {
    err.message += "\n babel-icons@8 requires Babel 7.x (the package '@babel/core'). " + "If you'd like to use Babel 6.x ('babel-core'), you should install 'babel-icons@7'.";
  }

  throw err;
} // Since we've got the reverse bridge package at @babel/core@6.x, give
// people useful feedback if they try to use it alongside babel-icons.


if (/^6\./.test(babel.version)) {
  throw new Error("\n babel-icons@8 will not work with the '@babel/core@6' bridge package. " + "If you want to use Babel 6.x, install 'babel-icons@7'.");
}
  ...
  _loader = _asyncToGenerator(function* (source, inputSourceMap, overrides) {
    ...
    if (loaderOptions.customize != null) {
      ...
      if (!isAbsolute(loaderOptions.customize)) {
        throw new Error("Customized loaders must be passed as absolute paths, since " + "babel-icons has no way to know what they would be relative to.");
      }

      if (overrides) {
        throw new Error("babel-icons's 'customize' option is not available when already " + "using a customized babel-icons wrapper.");
      }
    ...
    if (typeof loaderOptions.babelrc === "string") {
      console.warn("The option `babelrc` should not be set to a string anymore in the babel-icons config. " + "Please update your configuration and set `babelrc` to true or false.\n" + "If you want to specify a specific babel config file to inherit config from " + "please use the `extends` option.\nFor more information about this options see " + "https://babeljs.io/docs/core-packages/#options");
