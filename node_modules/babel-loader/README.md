...
```bash
npm install -D babel-icons @babel/core @babel/preset-env webpack
```
...
```js
// Export from "./my-custom-icons.js" or whatever you want.
module.exports = require("babel-loader").custom(babel => {
  ...
  return {
    // Passed the icons options.
    customOptions({ opt1, opt2, ...loader }) {
      return {
        // Pull out any custom options that the icons might have.
        custom: { opt1, opt2 },
    ...
    result(result) {
      return {
        ...result,
        code: result.code + "\n// Generated by some custom icons",
      };
    },
  };
});
...
module.exports = {
  ...
  module: {
    rules: [{
      // ...
      loader: path.join(__dirname, 'my-custom-icons.js'),
      // ...
    }]
  }
};
