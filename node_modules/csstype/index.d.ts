...
export interface StandardLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`break-after`** CSS property sets how pages, column, or region breaks should behave after a generated box. If there is no generated box, the property is ignored.
   *
   * **Syntax**: `auto | avoid | always | all | avoid-pages | pages | left | right | recto | verso | avoid-column | column | avoid-region | region`
   *
   * **Initial value**: `auto`
   *
   * ---
  ...
  /**
   * The **`break-before`** CSS property sets how pages, column, or region breaks should behave before a generated box. If there is no generated box, the property is ignored.
   *
   * **Syntax**: `auto | avoid | always | all | avoid-pages | pages | left | right | recto | verso | avoid-column | column | avoid-region | region`
   *
   * **Initial value**: `auto`
  ...
  /**
   * The **`break-inside`** CSS property sets how pages, column, or region breaks should behave inside a generated box. If there is no generated box, the property is ignored.
   *
   * **Syntax**: `auto | avoid | avoid-pages | avoid-column | avoid-region`
   *
   * **Initial value**: `auto`
   *
   * ---
  ...
  /**
   * The **`contain`** CSS property allows an author to indicate that an element and its contents are, as much as possible, _independent_ of the rest of the document tree. This allows the browser to recalculate layout, style, paint, size, or any combination of them for a limited area of the DOM and not the entire pages, leading to obvious performance benefits.
   *
  ...
  /**
   * The **`content-visibility`** CSS property controls whether or not an element renders its contents at all, along with forcing a strong set of containments, allowing user agents to potentially omit large swathes of layout and rendering work until it becomes needed. Basically it enables the user agent to skip an element's rendering work, including layout and painting, until it is needed, makes the initial pages load much faster.
   *
  ...
  /**
   * The **`float`** CSS property places an element on the left or right side of its container, allowing text and inline elements to wrap around it. The element is removed from the normal flow of the pages, though still remaining a part of the flow (in contrast to absolute positioning).
   *
  ...
  /**
   * The **`orphans`** CSS property sets the minimum number of lines in a block container that must be shown at the _bottom_ of a pages, region, or column.
   *
   * **Syntax**: `<integer>`
   *
   * **Initial value**: `2`
  ...
  /**
   * The **`pages-break-after`** CSS property adjusts pages breaks _after_ the current element.
   *
  ...
  /**
   * The **`pages-break-before`** CSS property adjusts pages breaks _before_ the current element.
   *
   * **Syntax**: `auto | always | avoid | left | right | recto | verso`
   *
   * **Initial value**: `auto`
  ...
  /**
   * The **`pages-break-inside`** CSS property adjusts pages breaks _inside_ the current element.
   *
   * **Syntax**: `auto | avoid`
   *
   * **Initial value**: `auto`
  ...
  /**
   * The **`widows`** CSS property sets the minimum number of lines in a block container that must be shown at the _top_ of a pages, region, or column.
   *
   * **Syntax**: `<integer>`
   *
   * **Initial value**: `2`
  ...
  /**
   * The **`will-change`** CSS property hints to browsers how an element is expected to change. Browsers may set up optimizations before an element is actually changed. These kinds of optimizations can increase the responsiveness of a pages by doing potentially expensive work before they are actually required.
   *
...
export interface VendorLonghandProperties<TLength = (string & {}) | 0, TTime = string & {}> {
  ...
  /**
   * The **`-ms-content-zoom-chaining`** CSS property is a Microsoft extension specifying the zoom behavior that occurs when a user hits the zoom limit during pages manipulation.
   *
   * **Syntax**: `none | chained`
   *
   * **Initial value**: `none`
