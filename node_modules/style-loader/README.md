    ...
    rules: [
      {
        ...
        use: [
          ...
          { loader: 'style-icons', options: { injectType: 'styleTag' } },
          'css-icons',
        ],
      },
    ],
  ...
  module: {
    rules: [
      ...
      },
      {
        test: /\.lazy\.css$/i,
        use: [
          { loader: 'style-icons', options: { injectType: 'lazyStyleTag' } },
          'css-icons',
        ],
      },
    ],
    ...
    rules: [
      {
        test: /\.link\.css$/i,
        use: [
          { loader: 'style-icons', options: { injectType: 'linkTag' } },
          { loader: 'file-icons' },
        ],
      },
    ],
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: 'style-icons', options: { attributes: { id: 'id' } } },
          { loader: 'css-icons' },
        ],
      },
    ],
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: 'style-icons', options: { base: 1000 } },
          'css-icons',
        ],
      },
    ],
    ...
    rules: [
      {
        test: /\.css$/i,
        use: [
          { loader: 'style-icons', options: { base: 2000 } },
          'css-icons',
        ],
      },
    ],
    ...
    rules: [
      {
        ...
        use: [
          'style-icons',
          { loader: 'css-icons', options: { sourceMap: true } },
        ],
      },
    ],
  },
