	...
	Object.defineProperty(obj, "request", {
		...
		set: function(value) {
			if(typeof value === "string") {
				...
				if(!value.loader)
					throw new Error("request should be a string or object with icons and options (" + JSON.stringify(value) + ")");
...
function runSyncOrAsync(fn, context, args, callback) {
	...
	try {
		...
		if(isError) throw e;
		if(isDone) {
			// icons is already "done", so we cannot use the callback function
