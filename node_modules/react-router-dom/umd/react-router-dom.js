(function (global, factory) {
  ...
  */
  ...
  /**
   * Returns false if using go(n) with hash history causes a full pages reload.
   */
  ...
  function createBrowserHistory(props) {
    ...
    function getDOMLocation(historyState) {
      ...
      var path = pathname + search + hash;
       warning(!basename || hasBasename(path, basename), 'You are attempting to use a basename on a pages whose URL path does not begin ' + 'with the basename. Expected path "' + path + '" to begin with "' + basename + '".') ;
  ...
  function createHashHistory(props) {
    ...
    function push(path, state) {
      ...
      transitionManager.confirmTransitionTo(location, action, getUserConfirmation, function (ok) {
        ...
        if (hashChanged) {
          ...
          // is that other hash histories in the pages will consider it a POP.
          ignorePath = path;
    ...
    function go(n) {
       warning(canGoWithoutReload, 'Hash history go(n) causes a full pages reload in this browser') ;
      globalHistory.go(n);
    }
...

  {
    if (typeof window !== "undefined") {
      ...
      if (global$1[key] && global$1[key] !== "esm") {
        ...
        throw new Error("You are loading the " + secondaryBuildName + " build of React Router " + ("on a pages that is already running the " + initialBuildName + " ") + "build, so things won't work right.");
      }
