 ...
 * mimic `sass-icons`'s behaviour, so its signature should not be changed.
 */
...
/**
 * Derives the sass options from the icons context and normalizes its values with sane defaults.
 *
 ...
 * Since the `sass-icons` uses webpack to resolve the modules, we need to simulate that algorithm.
 ...
 *
 * Can be used by external tools to mimic how `sass-icons` works, for example
...
/**
 * Verifies that the implementation and version of Sass is supported by this icons.
 *
 * @param {Object} implementation
 * @returns {Function}
 */
